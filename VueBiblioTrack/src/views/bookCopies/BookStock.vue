        ...
        <div class="card-body p-3">
          <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
              <thead>
                <tr>
                  <th class="ps-3 small text-muted" style=" max-width: 300px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" >Title</th>
              ...
              <tbody>
                <tr v-for="book in books" :key="book.bookId">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-semibold small" 
                            style=" max-width: 300px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" :title="book.title">
                          {{ book.title }}
                        </div>
                      </div>
                    </div>
                  ...
                  <td 
                    class="fw-semibold small text-end text-primary-subtle"   
                     @click="
                          router.push({
