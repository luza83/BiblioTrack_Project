<template>
  <div class="container-fluid px-5">
    ...
    <div v-else>
      <div>
        <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center p-3">
          ...
          <button class="btn btn-primary-subtle btn-sm gap-2 rounded-1 px-4 py-2" @click="viewBookCopyDetails(copy)">
                ...
                <tr v-for="copy in bookCopies" :key="copy.copyId">
                  ...
                  <td>
                    <div class="d-flex gap-3">
                      ...
                      <button class="btn btn-danger btn-sm" @click="handleBookCopyDelete(copy.copyId)">
    ...
    <BookCopyUpsertModal :bookCopy="selectedBookCopy" :bookId="bookId" @close="closeBookCopyModal"
      @status-updated="fetchBookCopies"></BookCopyUpsertModal>
  </div>
</template>
<script setup>
